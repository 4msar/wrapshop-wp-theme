(function ($) {
	...
	var wrapshopJS = {
		...
		initReady: function() {
			...
			//this.slickity('.wrapshop-recent-products .products', '.product');
			this.cattoggle();
			this.scrollTop();
			this.setheight();
			this.searchform();
		...
		mobileNavigation: function() {
			...
			var $secondary_menu = jQuery('.wrapshop-secondary-navigation');
			var $first_menu = '';
			var $second_menu = '';
		...
		searchform: function() {
			jQuery('.wrapshop-product-search').each(function() {
				var defaultVal = jQuery('.wrapshop-cat-list').val();
				if ( defaultVal === '') {
					jQuery('.nav-search-label').text('All');
				} else {
					jQuery('.nav-search-label').text(defaultVal);
				}
				jQuery('.wrapshop-cat-list').on('change', function() {
					...
					jQuery('.wrapshop-product-search input[type="text"]').focus();
				});
			});
		},
